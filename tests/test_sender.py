...
def _audio_proto() -> MessageProto:
    proto = MessageProto()
    proto.audio_message.ptt = True
    proto.audio_message.media_key = b"\x23" * 32
    return proto


def _sticker_proto() -> MessageProto:
    proto = MessageProto()
    proto.sticker_message.mimetype = "image/webp"
    proto.sticker_message.media_key = b"\x24" * 32
    return proto
